            ...
            <div class={style.footerPadding}>
              <footer class={style.footerItems}>
                <a
                  ...
                  href="https://github.com/Bit-Blazer/squoosh/blob/HEAD/README.md#privacy"
                >
                  Privacy
                </a>
                <a
                  class={style.footerLink}
                  href="https://github.com/Bit-Blazer/squoosh/tree/HEAD/squoosh-cli"
                >
                  Squoosh CLI
                </a>
                <a
                  class={style.footerLinkWithLogo}
                  href="https://github.com/Bit-Blazer/squoosh"
                >
