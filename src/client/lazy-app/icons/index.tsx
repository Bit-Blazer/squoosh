...
const Icon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
export const ToggleAliasingIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
    <circle
      cx="12"
      cy="12"
...
export const ToggleAliasingActiveIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const ToggleBackgroundIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const RotateIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const AddIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
    <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" />
  </Icon>
);

export const RemoveIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
    <path d="M19 13H5v-2h14v2z" />
  </Icon>
);

export const UncheckedIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const CheckedIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const ExpandIcon = (props: preact.JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
